      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <div className="w-full flex items-center gap-10">
          <button
            ...
            className="w-[300px] px-6 py-2 bg-clip-text bg-white text-green-800 font-bold uppercase border-2 border-orange-200"
          >
      ...
      <div>
        ...
        task === "Add an Existing Indicator" ? (
          <AddExistingIndicator
            goal={goal}
            availableIndicators={
              availableIndicators as unknown as GoalIndicator[]
            }
            requiredData={requiredData}
          />
