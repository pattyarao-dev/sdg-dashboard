...
// Helper function to get most recent recorded value
export const getMostRecentValue = (data: TemporalValue[]): number => {
  ...
  // Return the value, handle undefined
...
// Filter SDG data based on criteria selected
...
// Get aggregate data for all indicators
...
// Helper function for goal achievement metrics
